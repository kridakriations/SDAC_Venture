...
func make_dormant(make_invisible = true):
	visible = false
	$body/CollisionShape.set_deferred("disabled",true)
	$body/head/CollisionShape.set_deferred("disabled",true)
	pass

func make_active(make_visible = true):
	visible = true
	$body/CollisionShape.set_deferred("disabled",false)
	$body/head/CollisionShape.set_deferred("disabled",false)
	pass
