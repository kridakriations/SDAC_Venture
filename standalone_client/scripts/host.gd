...
func _ready():
	...
	if(Server.is_connected("all_clients_ready",self,"make_start_button_active") == false):
		Server.connect("all_clients_ready",self,"make_start_button_active")
	if(Server.is_connected("all_clients_not_active",self,"make_start_button_in_active") == false):
		Server.connect("all_clients_not_active",self,"make_start_button_in_active")
